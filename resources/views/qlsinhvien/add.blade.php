    ...
    <section class="content">
        <div class="card">
          <div class="card-body p-4">
            <form action="{{ url('addPost') }}" method="POST" id="frn-add-sv" >
               @csrf
                <div class="form-group">
                    <label for="department">Mã sinh viên</label>
                    <input type="text" class="form-control" id="msv" name="msv" placeholder="Hãy nhập mã sinh viên" data-rule-required="true" data-msg-required="Vui lòng nhập mã sinh viên.">
                </div>
                <div class="form-group">
                    <label for="department">Tên sinh viên</label>
                    <input type="text" class="form-control" id="name" name="name" placeholder="Hãy nhập tên sinh viên" data-rule-required="true" data-msg-required="Vui lòng nhập mã sinh viên.">
                </div>
                <div class="form-group">
...
<script>
    var braches = $("#braches option:selected").val();
