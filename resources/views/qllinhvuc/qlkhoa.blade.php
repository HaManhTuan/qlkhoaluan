        ...
        <div class="modal-dialog bounceInRight animated">
          <div class="modal-content">
            ...
            <div class="modal-body">
             <form action="{{ url('postqlkhoa') }}" method="POST" id="frm-add" onsubmit="return false;">
               @csrf
                <div class="form-group">
                    <label for="department">Tên Khoa</label>
                    <input type="text" class="form-control" id="department" name="department" placeholder="Hãy nhập tên khoa" data-rule-required="true" data-msg-required="Vui lòng nhập tên Khoa.">
                  </div>
            </div>
        ...
        <div class="modal-dialog bounceInRight animated">
          <div class="modal-content">
            <div class="modal-header">
             ...
             <form action="{{ url('postupdateqlkhoa') }}" method="POST" id="frm-update" onsubmit="return false;">
               @csrf
            <div class="modal-body">
  ...
  <script>
    ...
    $(".btn-del-depart").on('click',function() {
      ...
      Swal({
        title: 'Xác nhận xóa?',
        type: 'error',
        html: '<p>Bạn sắp xóa 1 Khoa.</p><p>Bạn có chắn chắn muốn xóa?</p>',
