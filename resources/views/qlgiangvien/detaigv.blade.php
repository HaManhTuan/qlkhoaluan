...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h4>Quản Lý Giang Viên</h4>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Trở Về</a></li>
              <li class="breadcrumb-item active">Đề Tài Của Bạn</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="card">
        <div class="card-header">
          <div class="card-title">
           ...
           <input class="form-control form-control-navbar" type="search" placeholder="Tên Đề Tài" aria-label="Search">
          ...
          <div class="card-tools">
            <div class="btn-groups">
                 <button type="button" class="btn btn-primary" data-toggle="modal"
                         data-target="#create-cust"><i class="fa fa-plus-circle"></i> Thêm Đê Tài
                 </button>
        ...
        <div class="card-body p-0">
          <table  class="table table-bordered table-striped">
                        ...
                        <tr>
                            ...
                            <th class="text-center" style="background-color: #fff;">Trạng Thái</th>
